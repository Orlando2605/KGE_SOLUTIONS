        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user me-2"> </i>KGE TEC</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    <a href="../../views/views_admin/index.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>INICIO</a>
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <i class=" fa fa-user rounded-circle me-lg-2" src="" alt="" style="width: 40px; height: 40px;"></i>
