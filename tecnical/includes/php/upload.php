                    ...
                    // Validar la extensión del archivo
                        if ($extension == "pdf" || $extension == "doc" || $extension == "docx") {
                            ...
                            if (move_uploaded_file($_FILES["factura"]["tmp_name"], $carpeta_destino . $nombre_archivo)) {
                                ...
                                include "../conexion/db.php";
                                $sqlnuevo = "INSERT INTO act_fijos_tec (codigo, marca, clave, descripcion, serie, existencia, usuarios, costo, factura, imagen, lugar, categoria) 
                        ...
                        if ($extension == "pdf" || $extension == "doc" || $extension == "docx") {
                            ...
                            if (move_uploaded_file($_FILES["factura"]["tmp_name"], $carpeta_destino . $nombre_archivo)) {
                                // Insertar la información del archivo en la base de datos
                                include "../conexion/db.php";
                                $sql = "INSERT INTO act_fijos_tec (codigo, marca, clave, descripcion, serie, existencia, usuarios, costo, factura, imagen, lugar, categoria) 
