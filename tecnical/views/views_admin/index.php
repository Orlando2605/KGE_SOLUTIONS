...
<body>
    ...
    <div class="container-fluid position-relative d-flex p-4">
        <div class="col-sm-12">
            <h2 style="text-align: center;" id="titulo">ACTIVOS FIJOS TECNOLOGI</h2>
            <br>
            <div>
 ...
 -->
            ...
            <div class="row" class="tabla">
                <div class="col-md-8" id="tabla1">
                    ...
                    $result_categorias = $conexion->query("SELECT DISTINCT categoria FROM act_fijos_tec");
                    ...
                    if ($result_categorias->num_rows > 0) {
                        while ($row_categoria = $result_categorias->fetch_assoc()) {
                            ...
                            $query = "SELECT id, codigo, marca, clave, serie, existencia, usuarios, costo, factura, descripcion, imagen FROM act_fijos_tec WHERE categoria = '$categoria_actual'";
