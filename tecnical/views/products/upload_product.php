        ...
        // Validar la extensión del archivo
            if ($extension == "pdf" || $extension == "doc" || $extension == "docx") {
                ...
                if (move_uploaded_file($_FILES["factura"]["tmp_name"], $carpeta_destino . $nombre_archivo)) {
                    ...
                    include "../../includes/conexion/db.php";
                    $sqlnuevo = "INSERT INTO products_tec (clave, marca, modelo, unidad, num_parte, descripcion, presentacion, grupo, tipo, precio, imagen, notas, factura) 
            ...
            if ($extension == "pdf" || $extension == "doc" || $extension == "docx") {
                ...
                if (move_uploaded_file($_FILES["factura"]["tmp_name"], $carpeta_destino . $nombre_archivo)) {
                    // Insertar la información del archivo en la base de datos
                    include "../../includes/conexion/db.php";
                    $sql = "INSERT INTO products_tec (clave, marca, modelo, unidad, num_parte, descripcion, presentacion, grupo, tipo, precio, imagen, notas, factura) 
