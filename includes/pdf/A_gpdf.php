...
class PDF extends FPDF {
    function Header() {
        ...
        $this->SetX(88);
        $this->MultiCell(0, 5, utf8_decode('REPORTE DE ESTADO ACTIVO'));
        // Email
        ...
        $this->SetX(2);
        // Establecer color de borde delgado
...
// Generar reporte para activos con valor '1' en el campo 'activo'
/* $activo = '1'; */
$consulta = "SELECT * FROM act_fijos WHERE activo = '1'";
